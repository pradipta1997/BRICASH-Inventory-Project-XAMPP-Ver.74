    ...
    <form action="" method="post">
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group" style="display: flex;">
                        <label class="col-sm-2 col-form-label ">Status QC</label>
                        <select class="form-control select2">
                            <option value="">--All Status--</option>
                            <option value="">Lolos QC</option>
                            <option value="">Tidak Lolos QC</option>
                        </select>
                    </div>
                </div>
            </div>
...
<div class="box text-sm">
    <div class="box-header">
        ...
        <!-- <span <?php echo $My_Controller->savePermission; ?>>
            | <a href='<?= base_url('Barangqcven/tambahBarangqcven') ?>' class='btn btn-info'>
                Add New <i class="fa fa-plus"></i>
            </a>
        </span> -->
    </div>
    <div class="box-body">
        <table id="tableBarangqcven" class="table table-bordered table-striped" style="width: 100%;">
            <thead>
                <tr>
                    <th>No</th>
                    <th>No PO</th>
                ...
                <div class="modal-body">
                    ...
                    <div class='form-group'>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <button type="button" class="btn btn-success" disabled id="dataSN" title="Generate Data" onclick="generateSN()"><i class="fa fa-refresh"></i></button>
                            </div>
                        </div>
                    </div>
                    <div class='form-group'>
                    ...
                    <div class='form-group'>
                        ...
                        <select name="id_rak" id="id_rak" class="form-control" required>
                            ...
                            <?php foreach ($rak as $rk) { ?>
                                <option value="<?= $rk->id_rak ?>"><?= $rk->nama_gudang . " | " . $rk->nama_rak ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <table class="table table-bordered" style="width: 100%;">
                        <tr>
                            ...
                            <td><input type="checkbox" name="flag_qc" id="flag_qc" value="2"> Bagus/Rusak</td>
                        </tr>
                        <tr>
                            <td>Status Greenpart</td>
                            <td class="text-center">:</td>
                            <td><input type="checkbox" name="flag_greenpart" id="flag_greenpart" value="1"> Greenpart/Not Greenpart</td>
                        </tr>
                        <tr>
                            <td>Status Retur Barang</td>
                            <td class="text-center">:</td>
                            <td><input type="checkbox" name="flag_retur" id="flag_retur" value="1"> Retur Barang/Not Retur</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Status Cacat</td>
                            <td class="text-center">:</td>
                            <td><input type="checkbox" name="flag_cacat" id="flag_cacat" value="1"> Tidak Cacat?</td>
                        </tr>
                        <tr>
                            <td>Status Fisik</td>
                            <td class="text-center">:</td>
                            <td><input type="checkbox" name="flag_fisik" id="flag_fisik" value="1"> Bagus/Rusak</td>
                        </tr>
                        <tr>
                            <td>Jenis Barang Sesuai Permintaan?</td>
                            <td>:</td>
                            <td><input type="checkbox" name="flag_sesuai" id="flag_sesuai" value="1"> Ya/Tidak</td>
                        </tr>
                    </table>
                    <div class='form-group'>
