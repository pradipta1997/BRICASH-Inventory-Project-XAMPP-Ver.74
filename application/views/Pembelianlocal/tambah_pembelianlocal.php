            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <input type="text" name="nomor_pembelian" id="nomor_pembelian" value="<?= $autoNoPemLocal ?>" class="form-control" style="color: red;" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <select class="form-control select2" name="id_uker" id="id_uker" required>
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <select class="form-control select2" name="id_vendor" id="id_vendor" required>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <input type="number" name="tempo_pembayaran" id="tempo_pembayaran" class="form-control" title="Input Tempo Pembayaran" required autocomplete="OFF">
                    </div>
                </div>
                            ...
                            <tbody id="rows-list">
                                <tr>
                                    <td class="product-list">
                                        <select class="form-control select2" name="no_urut[]" required>
                                    ...
                                    <td>
                                        <input type="number" name="total_ppn[]" value="0" class="form-control Pemlocppn" readonly>
                                    </td>
                                    <td>
                                        <input type="number" name="total[]" value="0" class="form-control PemlocTotal" readonly>
                                    </td>
                                    <td>
                                        <input type="text" name="keterangan[]" class="form-control pemlocKet" required autocomplete="OFF">
                                    </td>
                                    <td align="center">
