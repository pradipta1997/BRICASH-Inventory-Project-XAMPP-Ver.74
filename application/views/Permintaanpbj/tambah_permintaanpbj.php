<form action="<?= base_url('Permintaanpbj/savePBJ') ?>" class="small" enctype="multipart/form-data" method="post">
    <section class="panel">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <input type="text" class="form-control" id="no_pbj" value="<?= $autoNoPerBar ?>" name="no_pbj" style="color: red;" readonly>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sandbox">
                        <label for="tanggal_po">Tanggal Permintaan</label>
                        <input type="date" name="tanggal_permintaan" id="tanggal_permintaan" value="<?= date('Y-m-d') ?>" class="form-control" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sandbox">
                        <label for="keterangan">Keterangan</label>
                        <input type="text" name="keterangan2" id="keterangan2" class="form-control" required>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top:20px;">
                <div class="col-md-12">
                    <div class="sandbox">
                        ...
                        <textarea name="terms" style="height:100px;" class="form-control" id="terms" required></textarea>
                    </div>
                </div>
            </div>
        </div>
