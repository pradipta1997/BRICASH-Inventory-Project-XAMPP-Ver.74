<?php if($po->wakadiv_approv == 1){ ?>
<form action="<?= base_url('Permintaanpbj/updatepbj/'.$po->id) ?>" class="small" enctype="multipart/form-data" method="post">
    <section class="panel">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <input type="date" name="tanggal_permintaan" id="tanggal_permintaan" value="<?= $po->tanggal_permintaan?>" class="form-control" readonly>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sandbox">
                        <label for="keterangan">Keterangan</label>
                        <input type="text" name="keterangan2" value="<?= $po->keterangan?>" id="keterangan2" class="form-control" readonly>
                    </div>
                </div>
            </div>
            <div class="row" style="margin-top:20px;">
                <div class="col-md-12">
                    <div class="sandbox">
                        ...
                        <textarea name="terms" style="height:100px;" class="form-control" id="terms" readonly><?= $po->terms ?></textarea>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered" width="100%">
                            ...
                            <?php
                                ...
                                ?>
                                    ...
                                    <td class="product-list">
                                        <select readonly class="form-control input-xlarge Perbar_barang select2" name="no_urut[]" id="no_urut[]" style="width: 100%;" title="Pilih Item Barang" required>
                                    ...
                                    <td>
                                        <input readonly type="number" value="<?= $pDet->qty ?>" name="qty[]" id="qty[]" class="form-control qty" required>
                                    </td>
                                    <td>
                                        <input readonly type="text" value="<?= $pDet->keterangan ?>" name="keterangan[]" class="form-control" required>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        ...
                        <div class="text-center">
                            <a id="printPageButton" href="<?= base_url('Permintaanpbj') ?>" class="btn btn-warning btn-sm">Kembali</a>
                            <a id="printPageButton" href="<?= base_url('Permintaanpbj/printpbj/'.$po->id) ?>" class="btn btn-primary btn-sm">Print</a>
                        </div>
                    </div>
                </div>
            </div>
