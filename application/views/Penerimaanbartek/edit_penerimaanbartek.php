<form action="" method="post">
    <section class="panel">
        <header class="panel-heading" style="background-color: black; color: white;">
            EDIT PENERIMAAN BARANG UNTUK TEKNISI
        </header>
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        <label for="tglPemenuhan">Tanggal Penerimaan</label>
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <input type="text" value="Suhendar" name="namaTeknisi" id="namaTeknisi" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <input type="text" value="Untuk Project D" name="keperluan" id="keperluan" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <input type="text" value="Sparepart" name="namaBarang" id="namaBarang" class="form-control">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="sandbox">
                        ...
                        <input type="text" value="-" name="keterangan" id="keterangan" class="form-control">
                    </div>
                </div>

                <div class="col-md-3">
                    <div class="sandbox">
                        <label for="statusPemenuhan">Status Penerimaan</label>
