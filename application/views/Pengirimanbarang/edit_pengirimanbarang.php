...
<form action="<?= base_url('Pengirimanbarang/addPengiriman/' . $pengiriman->id_pengiriman) ?>" method="post">
    <section class="panel">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="text" name="noPermintaan" value="<?php echo $pengiriman->no_pengiriman; ?>" id="noPermintaan" class="form-control">
                                                            <input type="hidden" name="id_pengiriman" value="<?php echo $pengiriman->id_pengiriman; ?>" id="id_pengiriman" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="date" name="tanggal_pengiriman" id="tanggal_pengiriman" value="<?php echo $pengiriman->tanggal_pengiriman; ?>" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="number" name="jumlah_permintaan" value="<?php echo $jumlahPermintaan[0]->jumlah_permintaan; ?>" id="jumlah_permintaan" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="number" value="<?php echo $jumlahPemenuhan[0]->jumlah_pemenuhan; ?>" name="jumlah_pemenuhan" id="jumlah_pemenuhan" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="number" name="sisa" id="sisa" value="<?php echo $jumlahPermintaan[0]->jumlah_permintaan-$jumlahPemenuhan[0]->jumlah_pemenuhan; ?>" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="pacbar">
                                        <div class="table-responsive">
                                            <table id="" class="table table-bordered  table-nowrap dataTable" cellspacing="0" width="100%">
                                                ...
                                                <tbody id="rows-list">
                                                <?php
                                                    $ditel = $this->General->fetch_records("v_pengirimankpkc", ['id_pengiriman' => $pengiriman->id_pengiriman]);
                                                    if($ditel){
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><input type="text" value="" name="no_sn[]" class="form-control carton no_sn" id="no_sn[]"></td>
                                                        <td>
                                                            <input type="number" value="" name="harga_barang[]" id="harga_barang[]" class="form-control rate harga_barang">
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <input type="number" value="" name="keterangan[]" id="keterangan[]" class="form-control keterangan">
                                                        </td>
                                                        <td class="text-center">
                                                            <input type="checkbox" id="status_pemenuhan[]" name="status_pemenuhan[]" class="status_pemenuhan" value="1">
                                                        </td>
                                                        <td align="center">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="number" name="j_koli" id="j_koli" value="<?php echo $pengiriman->jumlah_koli; ?>" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                        </section>
...
<script>
    $(document).ready(function() {
        ...
        $('#status_pemenuhan').click(function(){
