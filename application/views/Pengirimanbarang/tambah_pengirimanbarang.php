...
<form action="<?= base_url('Pengirimanbarang/newPengiriman') ?>" method="post">
    <section class="panel">
        <header class="panel-heading" style="background-color: black; color: white;">
            TAMBAH PENGIRIMAN BARANG KE KP/KC
        </header>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" role="tabpanel" id="pengbar">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="text" style="color: red;" readonly name="noPermintaan" value="<?= $autoNoPertek ?>" id="noPermintaan" class="form-control">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="date" name="tanggal_pengiriman" id="tanggal_pengiriman" value="" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="number" name="jumlah_permintaan" id="jumlah_permintaan" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="number" name="jumlah_pemenuhan" id="jumlah_pemenuhan" class="form-control" required>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="number" name="sisa" id="sisa" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            <label for="sisa">Estimasi Pengiriman</label>
                                                            <input type="number" name="estimasi" id="estimasi" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                    ...
                                    <ul class="list-inline pull-right">
                                        <li><button type="button" class="btn btn-primary btn-sm next-step" style="margin-right: 10px; font-weight:bold">Save and continue</button></li>
                                    </ul>
                                </div>
                                <div class="tab-pane" role="tabpanel" id="pacbar">
                                                        ...
                                                        <td class="product-list">
                                                            <select class="form-control no_urut" name="no_urut[]" style="width: 100%;" id="no_urut[]" required>
                                                                ...
                                                                <?php foreach ($namaBarang as $val) { ?>
                                                                    <option value="<?php echo $val->no_urut ?>"><?= $val->nama_barang ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <input type="text" name="no_sn[]" class="form-control carton" required>
                                                        </td>
                                                        <td>
                                                            <input type="number" name="harga_barang[]" class="form-control rate" required>
                                                        </td>
                                                        <td>
                                    ...
                                    <ul class="list-inline pull-right">
                                        <li><button type="button" class="btn btn-default btn-sm prev-step" style="margin-right: 10px; font-weight:bold">Previous</button></li>
                                        <li><button type="button" class="btn btn-primary btn-sm next-step" style="margin-right: 10px; font-weight:bold">Save and continue</button></li>
                                    </ul>
                                </div>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="sandbox">
                                                            ...
                                                            <select class="form-control d_type" name="d_type" style="width: 100%;" id="d_type" required>
                                                                ...
                                                                <?php foreach ($deliveryType as $val) { ?>
                                                                    <option value="<?php echo $val->id_delivery_type ?>"><?= $val->nama_delivery_type ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="sandbox">
                                                            ...
                                                            <select class="form-control id_ekpedisi" name="id_ekpedisi" style="width: 100%;" id="id_ekpedisi" required>
                                                                ...
                                                                <?php foreach ($ekspedisi as $val) { ?>
                                                                    <option value="<?php echo $val->id_ekpedisi ?>"><?= $val->nama_ekpedisi ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="sandbox">
                                                            ...
                                                            <select class="form-control id_uker" name="id_uker" style="width: 100%;" id="id_uker" required>
                                                                ...
                                                                <?php foreach ($uker as $val) { ?>
                                                                    <option value="<?php echo $val->id_uker ?>"><?= $val->nama_uker ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="sandbox">
                                                            ...
                                                            <input type="number" name="j_koli" id="j_koli" value="" class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div>
                                        </section>
